...
public class C14474048_PCMR extends PApplet {
...
public void setup()
{
  ...
  menu.setBackgroundColour(color(0xffffd700));
...
//creating the scale so the people know
  ...
  stroke(255,0,0);
  line(width/4,height/2-border,width/2,height/2-border);
  fill(0xffFFDF00);
  textAlign(LEFT,BOTTOM);
  text("AMD users: "+(int)AMD,width/4,(height/2)-border);
  ...
  fill(0xffFFDF00);
  textAlign(LEFT,BOTTOM);
  text("Other(INTEL) users: "+(int)OTHER,width/4,(height/2));
  
    stroke(0xff32b600);
  line(width/4,height/2-(border*2),width/2,height/2-(border*2));
  fill(0xffFFDF00);
  textAlign(LEFT,BOTTOM);
  text("NVIDIA users: "+(int)NVIDIA,width/4,(height/2)-(border*2));
  
}

//------------------------------------------------------------------------------------------OPTION 2 STEMLEAF-------------------------------------------------------------------------------
public void Stemleaf()
{
  background(0);
  ...
  line( (width/2)+50, 0, (width/2) +50, height );
  line(0, height*.1f, width, height*.1f);
  textAlign(CENTER);
  fill(255);
  text("COST IN \u20ac", width/2, height*.05f);
  text("amount of AMD users", width/4, height*.05f);
  text("amount of NVIDIA users", (width-(width/6)), height*.05f);
...
class Dataset
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "C14474048_PCMR" };
    if (passedArgs != null) {
